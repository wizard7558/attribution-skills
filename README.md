...
| [`clickstream-identity-stitching`](skills/clickstream-identity-stitching) | 0.1.0 | Identity dedupe, non-destructive graph, and verified webhook resolution | Deterministic suite passes; Sonnet supplements published (4/4); Fable graph supplement published (2/2); Qwen without-skill in flight; Qwen with-skill truncated (n/a) |
...
| Identity corrected graph (Fable graph ×2 complete and published in [fable graph supplement](skills/clickstream-identity-stitching/references/eval-results-fable-graph-supplement.md); Qwen without-skill in flight; Qwen with-skill still truncated n/a from prior [qwen graph supplement](skills/clickstream-identity-stitching/references/eval-results-qwen-graph-supplement.md)) | `clickstream-identity-stitching` | Decide truncation policy; rerun only never-run or failed cells on manifest `71a0c119`; original matrix published on prior manifest `9e2b5e6e` |
