...
| Catalog residual gaps | all twelve | Shippable with honest residuals: GA4 4× `TimeoutExpired` n/a (retried); hosted pixel adapter smoke blocked pending disposable Vercel+Neon/Supabase/Cloudflare teardown targets. No fabricated scores. |
