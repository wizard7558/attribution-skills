...
Deterministic test results and model behavior evaluations are separate evidence. Published matrices for taxonomy (18/18), GA4 (14/18), tripwires/MMM/funnel/CRM skills, and identity supplements are honest about transport and truncation gaps. The Qwen with-skill identity-graph cell still truncates at the 8192-token output cap and remains an outstanding blocker, not a knowledge score.
...
| Pixel live matrix (18 cells) | `first-party-pixel` | In flight 2026-09-09 under private `Downloads/pixel-audit-live-20260909T2150Z/` (Sonnet 600s wrapper); publish redacted results when terminal |
| Audit live matrix (18 cells) | `attribution-audit` | Queued after pixel in the same private live batch; publish when terminal |
