...
Deterministic test results and model behavior evaluations are separate evidence. Published matrices for taxonomy (18/18), GA4 (14/18), pixel (18/18), audit (18/18), tripwires/MMM/funnel/CRM skills, and identity supplements are honest about transport and truncation gaps. The Qwen with-skill identity-graph cell still truncates at the 8192-token output cap and remains an outstanding blocker, not a knowledge score.
