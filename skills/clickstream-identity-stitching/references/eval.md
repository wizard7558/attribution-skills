...
Published original matrix: [eval-results.json](eval-results.json), [eval-results.md](eval-results.md), and [eval-results-provenance.json](eval-results-provenance.json) on prior manifest `9e2b5e6e` (current manifest `71a0c119`). Provenance documents the manifest mismatch; rescore was skipped and scores are preserved from the original execution. Published supplements: [eval-results-sonnet-supplement.json](eval-results-sonnet-supplement.json) (4/4 complete at 600s on manifest `71a0c119`), [eval-results-fable-graph-supplement.json](eval-results-fable-graph-supplement.json) (2/2 complete on manifest `71a0c119`), [eval-results-qwen-graph-without-supplement.json](eval-results-qwen-graph-without-supplement.json) (single without-skill graph cell complete, 574/1188), [eval-results-qwen-graph-with-16k-supplement.json](eval-results-qwen-graph-with-16k-supplement.json) (single with-skill graph cell complete at `num_predict` 16384, 706/1188), and [eval-results-qwen-graph-supplement.json](eval-results-qwen-graph-supplement.json) (superseded 8192 attempt, incomplete n/a).

Corrected live graph supplements on manifest `71a0c119` are complete. The original frozen matrix is retained as historical evidence: 18 attempts, 13 usable outputs, four Sonnet transport timeouts and one Qwen output-limit truncation. Original graph ordering scores are not a reliable identity-semantic comparison because the supplied observation-order rule was ambiguous. No original score, raw response, or failure was overwritten.
...
Corrected graph supplements are published; transport failures and truncated output remain unavailable evidence, not knowledge misses; no score is inferred for them.
