...
-- BEGIN GENERATED LANDING UTM EVIDENCE
CREATE TEMP FUNCTION extract_landing_utm_evidence(landing_url STRING)
...
return result;
''';
-- END GENERATED LANDING UTM EVIDENCE
...
SELECT source_system, source_scope,
  session_source AS session_last_click_source,
  session_medium AS session_last_click_medium,
  u.landing_url_status,
  u.utm_source AS landing_utm_source,
  u.utm_medium AS landing_utm_medium,
  u.utm_campaign AS landing_utm_campaign,
  COUNT(*) AS sessions
FROM classified
CROSS JOIN UNNEST([extract_landing_utm_evidence(landing_page_location)]) AS u
GROUP BY source_system, source_scope, session_last_click_source, session_last_click_medium,
  landing_url_status, landing_utm_source, landing_utm_medium, landing_utm_campaign
ORDER BY sessions DESC, source_system, source_scope, session_last_click_source,
  session_last_click_medium, landing_url_status, landing_utm_source, landing_utm_medium, landing_utm_campaign
LIMIT 20;
