...
SELECT source_system, source_scope, landing_page_path,
  COUNT(*) AS sessions,
  COUNTIF(engaged) AS engaged_sessions,
  SUM(key_events) AS key_events
FROM classified
GROUP BY source_system, source_scope, landing_page_path
ORDER BY sessions DESC, source_system, source_scope, landing_page_path
LIMIT 20;
