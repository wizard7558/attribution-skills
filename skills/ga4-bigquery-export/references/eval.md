...
The matrix is three groups × with-skill/without-skill × Fable 5.1, Sonnet 5 and Qwen3:4b = **18 cells; 14 complete, 4 transport failures (n/a)**. Outstanding cells: `claude-fable-5-1/without-skill/transactions-and-execution`, `claude-sonnet-5/with-skill/transactions-and-execution`, `claude-sonnet-5/without-skill/sessions-and-source-evidence`, `claude-sonnet-5/without-skill/transactions-and-execution`. The [manifest](eval-cases.json) has eight neutral A–H cases per group.
